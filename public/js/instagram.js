var sbiajaxurl = "https://instagram.bretz-austria.at/wp-admin/admin-ajax.php";
	...
	(() => {
		var t = {
						...
						(ct = window),
							...
							"function" == typeof n
								? ((o = {
								  ...
								  (s = n.call(o.exports, i, o.exports, o)),
								  (o.loaded = !0),
								  void 0 === s && (s = o.exports))
								: (s = n),
							window,
							(r = function () {
								"use strict";
								...
								function o(e) {
									if (
										...
										for (
											var d = (r.isBorderBox = "border-box" == o.boxSizing),
												u = 0;
											u < l;
											u++
										) {
										...
										var f = r.paddingLeft + r.paddingRight,
											...
											w = d && a,
											x = t(o.width);
										!1 !== x && (r.width = x + (w ? 0 : f + b));
										var C = t(o.height);
										return (
											!1 !== C && (r.height = C + (w ? 0 : m + y)),
											(r.innerWidth = r.width - (f + b)),
											(r.innerHeight = r.height - (m + y)),
							...
							"function" == typeof r
								? ((h = { id: "get-size/get-size", exports: {}, loaded: !1 }),
								  (a = r.call(h.exports, i, h.exports, h)),
								  (h.loaded = !0),
								  void 0 === a && (a = h.exports))
								: (a = r),
							(function (t, e) {
								"use strict";
								(d = function () {
									...
									"function" == typeof d
										? ((u = {
										  ...
										  (l = d.call(u.exports, i, u.exports, u)),
										  (u.loaded = !0),
								...
								return (
									...
									(s.getSegmentSize = function (t, e) {
										...
										if ((this._getMeasurement(i, s), !this[i])) {
											...
											this[i] =
												(n && n[s]) || this.smashotope.size["inner" + e];
										}
									}),
									...
									(s.getSize = function () {
										this.smashotope.getSize(),
											(this.size = this.smashotope.size);
									}),
									(i.modes = {}),
							...
							!(function (t, e, i, s) {
								...
								(n.Defaults = {
									...
									(n.prototype.is = function (t) {
										return (
											this._states.current[t] && this._states.current[t] > 0
										);
									}),
									...
									(n.prototype.relative = function (t) {
										return (
											(t -= this._clones.length / 2), this.normalize(t, !0)
										);
									}),
									(n.prototype.maximum = function (t) {
										...
										if (n.loop)
											...
											for (
												...
												e-- &&
												!(
													(i += this._items[e].width() + this.settings.margin) >
													s
												);
							...
							(ut.Defaults = { autoRefresh: !0, autoRefreshInterval: 500 }),
							(ut.prototype.watch = function () {
								this._interval ||
									((this._visible = this._core.$element.is(":visible")),
									(this._interval = dt.setInterval(
										lt.proxy(this.refresh, this),
							...
							(ut.prototype.destroy = function () {
								var t, e;
								for (t in (dt.clearInterval(this._interval), this._handlers))
							...
							(function (t, e, i, s) {
										...
										(this._handlers = {
											...
											"refreshed.owl.carousel": t.proxy(function (t) {
												t.namespace &&
													...
													this._core.$stage
														.find(".cloned .sbi-owl-video-frame")
														.remove();
											}, this),
											"changed.owl.carousel": t.proxy(function (t) {
												t.namespace &&
								...
								(n.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
									(n.prototype.fetch = function (t, e) {
										var i = t.attr("data-vimeo-id")
											...
											s =
												...
												t.attr("data-vzaar-id"),
											n =
												t.attr("data-width") || this._core.settings.videoWidth,
											o =
												t.attr("data-height") ||
									...
									(n.prototype.thumbnail = function (e, i) {
										...
										if (
											(e.wrap(
												'<div class="sbi-owl-video-wrapper"' + o + "></div>"
											),
											this._core.settings.lazyLoad &&
										...
										"youtube" === i.type
											? ((n =
													"//img.youtube.com/vi/" + i.id + "/hqdefault.jpg"),
											  d(n))
											: "vimeo" === i.type
											? t.ajax({
													type: "GET",
									...
									(n.prototype.play = function (e) {
										...
										this._playing ||
											...
											t(
												'<div class="sbi-owl-video-frame">' + i + "</div>"
											).insertAfter(s.find(".sbi-owl-video")),
								...
								(n.Defaults = { animateOut: !1, animateIn: !1 }),
									...
									(n.prototype.clear = function (e) {
										t(e.target)
											.css({ left: "" })
											.removeClass(
												"animated sbi-owl-animated-out sbi-owl-animated-in"
											)
								...
								function n(e, i) {
									...
									return (
										t.each(
											(e + " " + r.join(n + " ") + n).split(" "),
											function (t, e) {
												if (undefined !== a[e]) return (s = !i || e), !1;
											}
										),
										s
									);
							...
							"function" == typeof q
								? ((V = { id: "packery/js/rect", exports: {}, loaded: !1 }),
								  (N = q.call(V.exports, i, V.exports, V)),
								  (V.loaded = !0),
								  void 0 === N && (N = V.exports))
								: (N = q),
							window,
							(U = [N]),
							(Y = function (t) {
							...
							(it = function (t, e, i, s, n) {
								...
								i.prototype.canFit = function (t) {
									return (
										this.width >= t.width - 1 && this.height >= t.height - 1
									);
								};
								...
								(l.itemDragMove = function (t, e, i) {
									...
									if (n) {
										...
										var o = this,
											a = new Date();
										this._itemDragTime && a - this._itemDragTime < d
											? (clearTimeout(this.dragTimeout),
											  (this.dragTimeout = setTimeout(s, d)))
							...
							"function" == typeof it
								? void 0 === (nt = it.apply((st = {}), et)) && (nt = st)
								: (nt = it),
							window,
							(at = [E, nt]),
							(ot = function (t, e) {
							...
							void 0 ===
								(rt = "function" == typeof ot ? ot.apply(e, at) : ot) ||
								(t.exports = rt),
							(ht = window.Zepto || window.jQuery),
							window,
							document,
							(Owl2row = function (t) {
								(this.owl = t),
									(this.owl.options = ht.extend(
										{},
										Owl2row.Defaults,
										this.owl.options
									)),
									(this.handlers = {
										"initialize.owl.carousel": ht.proxy(function (t) {
											!0 !== this.owl.settings.owl2row ||
											ht("#sb_instagram").hasClass("2rows")
												? ht("#sb_instagram").removeClass("2rows")
												: (this.build2row(this),
												  ht("#sb_instagram").addClass("2rows"));
										}, this),
									}),
							...
							(Owl2row.prototype.build2row = function (t) {
								...
								ht.each(i, function (t, e) {
									...
									"ltr" === t.owl.options.owl2rowDirection
										? t.leftToright(t, e, i)
										: t.upTodown(t, s, n, e);
							}),
								...
								o % 2 == 1 ? (o = (o - 1) / 2 + 1) : (o /= 2),
									...
									ht.each(a, function (t, i) {
										var o = ht('<div class="' + s + '"/>'),
											h = a[t];
										(h.style.marginBottom = n + "px"),
											o.append(h).append(r[t]),
											e.append(o);
									});
							}),
							(Owl2row.prototype.upTodown = function (t, e, i, s) {
								...
								ht.each(e, function (t, a) {
									var r = ht('<div class="' + n + '"/>'),
										h = e[t];
									(h.style.marginBottom = o + "px"),
										r.append(h).append(i[t]),
										s.append(r);
								});
							}),
							(Owl2row.prototype.destroy = function () {}),
							(ht.fn.sbiOwlCarousel.Constructor.Plugins.owl2row = Owl2row);
						var gt = {
							"fa-clock":
									...
									jQuery(this)
										...
										.each(function () {
											...
											if (t && void 0 !== gt[t[0]]) {
												...
												jQuery(this).replaceWith("<svg " + i + gt[t[0]]);
						...
						if (
											...
											do {
												(g = l),
													...
													(_ = n[v]) &&
														...
														(m = l.match(new RegExp("\\" + v, "g"))),
														(f ? f.length : 0) < (m ? m.length : 0) &&
							...
							Function.prototype.bind ||
								(Function.prototype.bind = function (t) {
									...
									return (
										(s.prototype = this.prototype), (n.prototype = new s()), n
									);
								}),
							...
							!(function (s, n, o, a) {
								...
								function d(t, e, i) {
									...
									return function () {
										...
										return (
											o && o.call(s.console, n, i), t.apply(this, arguments)
										);
									};
								}
								function u(t, e, i) {
								...
								function C(t, e) {
									for (
										var i, s, n = e[0].toUpperCase() + e.slice(1), o = 0;
										o < ht.length;
								...
								function j(t) {
									var e = t.length;
									if (1 === e)
										return { x: ut(t[0].clientX), y: ut(t[0].clientY) };
									for (var i = 0, s = 0, n = 0; e > n; )
										(i += t[n].clientX), (s += t[n].clientY), n++;
									return { x: ut(i / e), y: ut(s / e) };
								}
								function k(t, e, i) {
								...
								function B(t, e) {
									...
									return (
										e & (zt | Tt) && (i = x(i.concat(s), "identifier", !0)),
										[i, s]
									);
								}
								function Q() {
								...
								function M(t, e) {
									...
									for (n = 0; n < a.length; )
										s[a[n].identifier] && r.push(a[n]),
											e & (zt | Tt) && delete s[a[n].identifier],
											n++;
									return r.length
										? [x(o.concat(r), "identifier", !0), r]
										: void 0;
								}
								function $() {
									z.apply(this, arguments);
								...
								function nt(t, e) {
									var i,
										s = t.element;
									s.style &&
										(l(t.options.cssProps, function (n, o) {
											(i = C(s.style, o)),
												e
								...
								var gt = d(
										function (t, e, i) {
											for (var s = Object.keys(e), n = 0; n < s.length; )
												(!i || (i && t[s[n]] === a)) && (t[s[n]] = e[s[n]]),
													n++;
											return t;
										},
										"extend",
								...
								z.prototype = {
									...
									init: function () {
										this.evEl && f(this.element, this.evEl, this.domHandler),
											...
											this.evWin &&
												f(I(this.element), this.evWin, this.domHandler);
									},
									destroy: function () {
										this.evEl && m(this.element, this.evEl, this.domHandler),
											this.evTarget &&
												m(this.target, this.evTarget, this.domHandler),
											this.evWin &&
												m(I(this.element), this.evWin, this.domHandler);
									},
								};
								var Bt = { mousedown: Ct, mousemove: It, mouseup: zt },
									Qt = "mousedown",
								...
								(q.prototype = {
									...
									emit: function (t) {
										...
										var i = this,
											s = this.state;
										le > s && e(i.options.event + V(s)),
											e(i.options.event),
											t.additionalEvent && e(t.additionalEvent),
											s >= le && e(i.options.event + V(s));
									},
									tryEmit: function (t) {
										return this.canEmit()
											? this.emit(t)
									...
									recognize: function (t) {
										var e = at({}, t);
										return p(this.options.enable, [this, e])
											? (this.state & (de | ue | ce) && (this.state = ae),
											  (this.state = this.process(e)),
											  void (
													this.state & (re | he | le | ue) && this.tryEmit(e)
											  ))
									...
									u(G, X, {
										...
										attrTest: function (t) {
											return (
												X.prototype.attrTest.call(this, t) &&
												(this.state & re ||
													(!(this.state & re) && this.directionTest(t)))
											);
										},
										emit: function (t) {
										...
										process: function (t) {
											...
											if (s && n && i) {
												...
												var o =
													...
													a =
														!this.pCenter ||
														S(this.pCenter, t.center) < e.posThreshold;
												if (
								...
								(ot = function (t, e) {
									...
									(t.fn.hammer = function (t) {
										...
										(e.Manager.prototype.emit =
											((s = e.Manager.prototype.emit),
											function (e, i) {
												s.call(this, e, i),
													t(this.element).trigger({ type: e, gesture: i });
											}));
								}),
								void 0 ===
									(rt = "function" == typeof ot ? ot.apply(e, at) : ot) ||
						...
						(function () {
									...
									return (
												...
												o = function () {
													jQuery(
														...
														jQuery("#sbi_lightbox")
															.find(".sbi-embed-wrap")
															.remove(),
														clearTimeout(n.moveSlide);
												};
											if (
												"function" !=
												typeof s("#sbi_lightbox").find(".sbi_lb-container")
													.hammer
											) {
												(at = [i(311), i(840)]),
													(ot = function (t, e) {
													...
													void 0 ===
														(rt =
															"function" == typeof ot ? ot.apply(e, at) : ot) ||
														(t.exports = rt);
											}
											s(
												"<div id='sbi_lightboxOverlay' class='sbi_lightboxOverlay'></div><div id='sbi_lightbox' class='sbi_lightbox'><div class='sbi_lb-outerContainer'><div class='sbi_lb-nav'><a class='sbi_lb-prev' href='#' ><p class='sbi-screenreader'>Previous Slide</p><span></span></a><a class='sbi_lb-next' href='#' ><p class='sbi-screenreader'>Next Slide</p><span></span></a></div><div class='sbi_lb-container-wrapper'><div class='sbi_lb-container' style='overflow:hidden;'><div class='sbi_lb-image-wrap-outer'><div class='sbi_lb-image-wrap'><img class='sbi_lb-image' src='' alt='Lightbox image placeholder'/></div></div><div class='sbi_lb-loader'><i class='fa fa-spin'></i></div></div><div class='sbi_lb-dataContainer'><div class='sbi_lb-data'><div class='sbi_lb-details'><span class='sbi_lb-caption'></span><span class='sbi_lb-number'></span><div class='sbi_lightbox_action sbi_share'><a href='JavaScript:void(0);'><i class='fa fa-share'></i>" +
													(function (t) {
														...
														return void 0 !== sbiTranslations[e]
															? sbiTranslations[e]
															: t;
													})("Share") +
												...
												(this.$lightbox = s("#sbi_lightbox")),
												(this.$overlay = s("#sbi_lightboxOverlay")),
												(this.$outerContainer = this.$lightbox.find(
													".sbi_lb-outerContainer"
												)),
												(this.$container =
													this.$lightbox.find(".sbi_lb-container")),
												...
												jQuery(document).on("click", function (t, e, i) {
													jQuery(t.target).closest(".sbi_lb-outerContainer")
														.length ||
														jQuery(t.target).closest(".sbi_lb-dataContainer")
															.length ||
														(jQuery(
															"#sbi_lightboxOverlay, #sbi_lightbox"
														).fadeOut(),
														mt() &&
															jQuery("#sbi_lightbox video.sbi_video").length &&
															jQuery(
																"#sbi_lightbox video.sbi_video"
															)[0].pause(),
														o(),
														jQuery("body").length &&
												...
												this.$lightbox.hide(),
												jQuery("#sbi_lightboxOverlay").on(
													"click",
													function (t) {
														return (
															o(),
															mt() &&
																jQuery("#sbi_lightbox video.sbi_video")
																	.length &&
																jQuery(
																	"#sbi_lightbox video.sbi_video"
																)[0].pause(),
															"sbi_lightbox" === s(t.target).attr("id") &&
																n.end(),
															!1
														);
													}
												...
												this.$lightbox
													...
													.on("click", function () {
														return (
															...
															n.changeImage(
																n.currentImageIndex === n.album.length - 1
																	? 0
																	: n.currentImageIndex + 1
															),
															!1
										...
										(n.prototype.start = function (t) {
											function e(t) {
												...
												if (
													t.hasClass("sbi_header_link") &&
													!1 !== n.storyData &&
													n.settings.consentGiven
												) {
													var a = n.storyData,
														r =
															"undefined" !== n.storyWait
																? parseInt(n.storyWait)
																: 5e3;
													jQuery(".sbi_lightbox")
													...
													var d =
															void 0 !== t.attr("data-video")
																? t.attr("data-video")
																: "",
														u = n.getAvatarUrl(t.attr("data-user")),
														c =
															void 0 !== t.attr("data-iframe")
																? t.attr("data-iframe")
																: "",
														p =
															void 0 !== t.attr("data-media-type")
																? t.attr("data-media-type")
																: "feed",
														g = n.getImageUrls(t.closest(".sbi_item"));
													n.settings.consentGiven ||
														((h = {}), "" !== d && (d = "link")),
														i.album.push({
															link: t.attr("href"),
											...
											var i = this,
												n = s(window);
											n.on("resize", s.proxy(this.sizeOverlay, this)),
												s("select, object, embed").css({
													visibility: "hidden",
												}),
												this.sizeOverlay(),
												(this.album = []);
											...
											if (r) {
												o = s(
													t.prop("tagName") + '[data-lightbox-sbi="' + r + '"]'
												);
										...
										(n.prototype.changeImage = function (t) {
											...
											this.$overlay.fadeIn(this.options.fadeDuration),
												this.$overlay.find(".sbi_lb-loader").fadeIn("slow"),
												this.$lightbox
													.find(
											...
											var n = new Image();
											(n.onerror = function () {
												e.$lightbox.hasClass("sbi_had_error")
													? (console.log("image loading error"), e.end())
													: (e.$lightbox.addClass("sbi_had_error"),
													  jQuery.each(e.album, function (t, i) {
													...
													window.innerWidth > 640 &&
														...
														e.options.fitImagesInViewport &&
															...
															(h =
																...
																e.containerRightPadding -
																20 -
																u -
																c),
															(r =
																l -
																e.containerTopPadding -
																e.containerBottomPadding -
																150),
															(n.width > h || n.height > r) &&
																(n.width / h > n.height / r
																	...
																	: ((o = r),
																	  ...
																	  i.width(a),
																	  i.height(o)))),
														e.sizeContainer(i.width(), i.height());
												}),
												(n.src = this.album[t].link),
										...
										(n.prototype.showImage = function () {
											this.$lightbox.find(".sbi-embed-wrap").remove(),
										...
										(n.prototype.updateDetails = function () {
											...
											if (
												...
												if (
													(jQuery("#sbi_lightbox").removeClass(
														"sbi_video_lightbox"
													),
													...
													if (
														...
														this.album[this.currentImageIndex].iframe)
													) {
														jQuery("#sbi_lightbox").find("video").remove(),
															jQuery("#sbi_lightbox")
																.find(".sbi-embed-wrap")
																.remove();
														var e = jQuery("#sbi_lightbox")
																.find(".sbi_lb-image")
																.height(),
															i = jQuery("#sbi_lightbox")
																.find(".sbi_lb-image")
																.width(),
															s = document.createElement("div");
														(s.className = "sbi-embed-wrap"),
															(s.style.display = "block"),
															(s.style.overflow = "hidden"),
															(s.style.position = "relative");
														var n = document.createElement("iframe");
														(n.src = this.album[this.currentImageIndex].iframe),
															(n.width = i + "px"),
															(n.height = e + 55 + "px"),
															(n.style.marginTop = "-55px"),
															(n.style.border = "none"),
															s.appendChild(n),
															jQuery(".sbi_lb-container").prepend(s),
														...
														jQuery("#sbi_lightbox")
															...
															0 == jQuery(".sbi_lightbox .sbi_video").length
																...
																: jQuery(".sbi_video").attr({
																		src: this.album[this.currentImageIndex]
																			.video,
																		poster:
																			this.album[this.currentImageIndex].link,
																		autoplay: "true",
											...
											if (
												("link" !== this.album[this.currentImageIndex].video ||
												jQuery(".sbi_lb-container-wrapper .sbi_gdpr_notice")
													.length
													? "link" !==
															this.album[this.currentImageIndex].video &&
												...
												jQuery(".sbi_lb-container-wrapper")
													...
													.remove(),
												void 0 !==
													jQuery(".sbi_lb-image-wrap").sbiOwlCarousel &&
													"" !== this.album[this.currentImageIndex].carousel &&
													void 0 !==
														this.album[this.currentImageIndex].carousel.data &&
													void 0 !==
														this.album[this.currentImageIndex].carousel.data[0])
											) {
															...
															setTimeout(function () {
																...
																l &&
																	(jQuery(".sbi_lb-image-wrap")
																		...
																		.find("img")
																		.before(
																			jQuery("#sbi_lightbox .sbi_video").first()
																		),
																	jQuery("#sbi_lightbox .sbi_video")
																		...
																		.play()),
																"svg" ===
																	window.sb_instagram_js_options.font_method &&
																	ft(o);
														},
											...
											jQuery(".sbi_lb-container-wrapper")
												...
												"story" === this.album[this.currentImageIndex].type
													? jQuery(".sbi_lightbox").removeClass(
															"sbi_lb-comments-enabled"
													  )
													: !1 !==
															this.album[this.currentImageIndex]
																.lightboxcomments &&
													  jQuery(".sbi_lightbox").addClass(
															"sbi_lb-comments-enabled"
													  ),
																...
																function () {
																	setTimeout(function () {
																		jQuery(
																			...
																			jQuery("#sbi_lightbox .sbi_lb-image-wrap")
																				.length &&
																				(jQuery(
																					"#sbi_lightbox .sbi_lb-image-wrap"
																				).sbiOwlCarousel("destroy"),
											...
											if (
												(jQuery(".sbi_lb-image").attr("alt", u),
												setTimeout(function () {
													jQuery(".sbi_video")
														.css("opacity", "1")
														.css("z-index", 1);
												...
												!1 !==
													this.album[this.currentImageIndex].lightboxcomments &&
												...
												var c = {
													...
													maxNumComments:
														this.album[this.currentImageIndex].numcomments,
													disableCache:
														...
														var s = {
															...
															success: function (e) {
																jQuery(".sbi_lb-dataContainer")
																	...
																	(window.sbi.commentCache[c.postID] = [
																		c.commentObj,
																		new Date().getTime() / 1e3 + 6e3,
																		c.numCommentsOnPage,
																	]),
																	"all" !== t
																		? c.replaceWithNewComments(c.commentObj)
																		: c.appendExistingComments();
															},
													...
													appendExistingComments: function () {
														...
														i > s
															...
															: o > 0 &&
															  ((a =
																	'<p class="sbi_loading_comments"><svg class="svg-inline--fa fa-spinner fa-w-16 fa-pulse" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="spinner" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M304 48c0 26.51-21.49 48-48 48s-48-21.49-48-48 21.49-48 48-48 48 21.49 48 48zm-48 368c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zm208-208c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zM96 256c0-26.51-21.49-48-48-48S0 229.49 0 256s21.49 48 48 48 48-21.49 48-48zm12.922 99.078c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.491-48-48-48zm294.156 0c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.49-48-48-48zM108.922 60.922c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.491-48-48-48z"></path></svg></p>'),
															  c.getRemoteComments(o, c.accountType, c.user));
														var r = "";
														if (void 0 !== e[0]) {
															...
															e.length + o < n
																...
																(r += a),
																(r += "</div>"),
																jQuery(".sbi_lb-dataContainer").append(r);
														}
													},
												...
												: void 0 !== this.album[this.currentImageIndex].user &&
												  jQuery.each(window.sbi.feeds, function () {
														void 0 !== this.availableAvatarUrls &&
															void 0 !== this.availableAvatarUrls[_[v].user] &&
															"undefined" !==
																this.availableAvatarUrls[_[v].user] &&
															(f =
																'<img src="' +
																this.availableAvatarUrls[_[v].user] +
																'" />');
												  }),
												ft(jQuery(".sbi_lightbox")),
												this.$lightbox
													.find(".sbi_lb-caption")
													.html(
														m +
										...
										(n.prototype.enableKeyboardNav = function () {
											s(document).on(
												"keyup.keyboard",
												s.proxy(this.keyboardAction, this)
											);
										}),
										...
										(n.prototype.keyboardAction = function (t) {
											...
											27 === i || s.match(/x|o|c/)
												? (e(),
												  mt() &&
														void 0 !==
															jQuery("#sbi_lightbox video.sbi_video")[0] &&
														jQuery("#sbi_lightbox video.sbi_video")[0].pause(),
												  jQuery("#sbi_lightbox video.sbi_video").css(
														"opacity",
														0
												  ),
												...
												? (0 !== this.currentImageIndex
												  ...
												  0 == jQuery("#sbi_lightbox .sbi-embed-wrap").length &&
														jQuery("#sbi_lightbox iframe").attr("src", ""),
												  jQuery(".sbi_gdpr_notice").remove())
												: ("n" !== s && 39 !== i) ||
												  (this.currentImageIndex !== this.album.length - 1
										...
										(n.prototype.end = function () {
											this.disableKeyboardNav(),
												s(window).off("resize", this.sizeOverlay),
							...
							(function (t) {
													...
													this.each(function (e) {
														function s() {
															(h.responsive ||
																...
																(l.actualSize =
																	l.get(0).offsetWidth +
																	l.get(0).offsetHeight / 1e4),
																l.sizeOld && l.actualSize !== l.sizeOld && a(),
																(l.sizeOld = l.actualSize),
																setTimeout(s, h.responsiveCheckTime));
														}
														function o() {
														...
														function a() {
															...
															void 0 === d.data("owidth") &&
																...
																h.fill ===
																f / m >= d.data("owidth") / d.data("oheight")
																	? ((t = "100%"),
																	  (i = "auto"),
																	  (s = Math.floor(f)),
																	  (n = Math.floor(
																	...
																	: ((t = "auto"),
																	  (i = "100%"),
																	  (s = Math.floor(
																			m * (d.data("owidth") / d.data("oheight"))
																	  )),
																	  (n = Math.floor(m))),
																(u = f - s),
																"left" ===
																	(o = h.horizontalAlign.toLowerCase()) &&
																	(g = 0),
																"center" === o && (g = 0.5 * u),
																"right" === o && (g = u),
																-1 !== o.indexOf("%") &&
														...
														return d.length
															? (d.data("sbi_imgLiquid_settings")
															  ...
															  void (n.bgs_Available && h.useBackgroundSize
																	? (-1 ===
																			l
																			...
																			l.css({
																				"background-image":
																					'url("' +
																					encodeURI(d.attr("src")) +
																					'")',
																			}),
																	  l.css({
																			"background-size": h.fill
																				? "cover"
																				: "contain",
																			"background-position": (
																				h.horizontalAlign +
																				...
																				: (d.data(
																				  ...
																				  (function t() {
																						d.data("sbi_imgLiquid_error") ||
																							...
																							d[0].height > 0
																								? (d.data(
																										"sbi_imgLiquid_loaded",
																										!0
																								  ),
																								  setTimeout(a, e * h.delay))
																								: setTimeout(
																										t,
																										h.timecheckvisibility
																								  ));
																				  })(),
																				  void s());
																	  })()))
								...
								function n(e, i, n) {
									s.call(this, e, i, n),
										(this.initLayout = function () {
											...
											if (
												((colstablet = n.general.colstablet),
												(this.$header = !1),
												...
												jQuery(".sbi").length < 2
													? (o.setStatus(!0),
													  i.find(".sbi_moderation_link").remove())
													: o.setStatus(!1),
													!0 === o.status &&
														((o.$self = i),
												...
												void 0 !== e.settings.general.carousel
													...
													? (s = "highlight")
													: void 0 !== e.settings.general.masonry &&
													  (s = "masonry");
															...
															t.find("#sbi_images.sbi_carousel").fadeIn(),
																...
																setTimeout(function () {
																	...
																	if ("onhover" === l);
																		...
																		"hide" === l && e.addClass("hide").hide();
																	"svg" ===
																		window.sb_instagram_js_options
																			.font_method &&
																		ft(t.find("#sbi_images.sbi_carousel"));
																}, 100);
														},
													});
											} else
											...
											var v = jQuery.Event("sbiafterlayoutinit");
											if (
												((v.feed = this),
												jQuery(window).trigger(v),
												...
												var b = t(this.el),
													y =
														void 0 !== b.attr("data-num") &&
														"" !== b.attr("data-num")
															? parseInt(b.attr("data-num"))
															: 1,
													w =
														void 0 !== b.attr("data-nummobile") &&
														"" !== b.attr("data-nummobile")
															? parseInt(b.attr("data-nummobile"))
															: y;
												if (y !== w) {
													var x = y;
													t(window).width() < 480 && (x = w),
														x < b.find(".sbi_item").length &&
															b
																.find(".sbi_item")
																.slice(x - b.find(".sbi_item").length)
																.remove();
												}
												i
													.find(".sbi_carousel")
													.sbiOwlCarousel(this.carouselArgs),
										...
										(this.appendNewPosts = function (e) {
											...
											i.find("#sbi_images .sbi_item").length
												...
												("highlight" !== s.layout && "masonry" !== s.layout) ||
													s.appendSmashotope();
										}),
										(this.setImageHeight = function () {
											...
											if (!e.hasClass("sbi_masonry")) {
												var i = e.find(".sbi_photo").eq(0).innerWidth(),
													...
													o = n / 2;
												(sbi_photo_width_manual =
													e.find("#sbi_images").width() / s - n),
													...
													e.find(".sbi-owl-nav").length &&
														setTimeout(function () {
															...
															var i =
																e.find(".sbi_photo").eq(0).innerWidth() / t;
															(i += parseInt(o) * (2 - t + 2)),
										...
										(this.setHighlight = function () {
											...
											var r = a / o,
												...
												d =
													e.find("#sbi_images").css("padding").indexOf(".") > -1
														? 1
														: 0;
										...
										(this.revealNewImages = function () {
											...
											e.find(".sbi-screenreader").each(function () {
												...
												e.find(".sbi_item.sbi_js_load_disabled").length &&
													e
														.find(".sbi_item.sbi_js_load_disabled")
														.addClass("sbi_new"),
												e.find(".sbi_item.sbi_new").each(function (e) {
													...
													!0 === o.status &&
														s.append(
															o.addModHtml("", s.attr("id").replace("sbi_", ""))
														);
													var a =
													...
													if (
														(s
															.find(".sbi_lightbox_link")
															.on("click", function () {
																d.removeClass("sbi_video_lightbox"),
																	s.hasClass("sbi_type_video") &&
																		(d.addClass("sbi_video_lightbox"),
																		jQuery(".sbi_video").attr({
														...
														var u = s.find(".sbi_info .sbi_caption"),
															c = u.data("text-limit"),
															p = u.data("cap-length"),
															g =
																void 0 !== i.settings.general.captionlength
																	...
																	: 50;
														(g = c > 0 ? parseInt(c) : g) < 1 && (g = 99999);
														var f = void 0 !== u ? u.html() : "";
														(f = r(f)), (p = p > 0 ? parseInt(p) : f.length);
														var m = h(f, g);
														if (m.length === f.length) return;
														u.html(m),
															p > g && s.find(".sbi_expand").show(),
															s
																.find(".sbi_expand a")
																.off("click")
																.on("click", function (t) {
																	...
																	s.hasClass("sbi_caption_full")
																		? (u.html(m),
																		  s.removeClass("sbi_caption_full"))
																		: (u.html(f),
																		  s.addClass("sbi_caption_full")),
																		i.afterResize();
																});
													}
													if (a || l) {
														if (l) {
															if (void 0 !== s.attr("data-shoppable"))
																var _ = s.attr("data-shoppable");
															else {
																var v = "";
																void 0 !==
																s.find(".sbi_link_area").attr("data-title")
																	? (v = s
																			.find(".sbi_link_area")
																			.attr("data-title"))
																	: void 0 !== s.find("img").attr("alt")
																	? (v = s.find("img").attr("alt"))
																	: void 0 !== s.find("video").attr("alt") &&
																	  (v = s.find("video").attr("alt"));
																_ = v.match(
																	/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g
																);
															}
															_ && s.find("a").attr("href", _);
														}
														s
															.find(".sbi_link:not(.sbi_link_customizer)")
															.addClass("sbi_disable_lightbox"),
															s
																.find(".sbi_playbtn")
																.prependTo(s.find(".sbi_photo"));
													} else {
														var b = s.find(".sbi_photo_wrap"),
															y = b.find(".sbi_link");
														(feedOptions = { hovereffect: "true" }),
															"none" == feedOptions.hovereffect
																? (y.css("background", "none").show(),
																  y
																		.find("*")
																		.hide()
																		.end()
																		.find(".sbi_link_area")
																		.show())
																: b.on("mouseenter mouseleave", function (t) {
																		switch (t.type) {
																			case "mouseenter":
												...
												e.find(".sbi_item.sbi_new").each(function (t) {
													...
													if (e.find(".sbi_hover_top .sbi_caption").length) {
														var s = e.find(".sbi_hover_top .sbi_caption"),
															...
															a =
																void 0 !== i.settings.general.captionlength
																	...
																	: 50;
														(hovertextLimit =
															void 0 !== i.settings.general.hovercaptionlength
																? parseInt(
																		i.settings.general.hovercaptionlength
																  )
																: a),
															(hovertextLimit =
																n > 0 ? parseInt(n) : hovertextLimit),
															hovertextLimit < 1 && (hovertextLimit = 99999);
														...
														s.html(d),
															d.length < l.length &&
																e
																	.find(".sbi_hover_top .sbi_caption")
																	.after("<span>...</span>");
													}
												}),
												jQuery(".sbi_lightbox_action a")
													...
													.on("click", function () {
														jQuery(this)
															.parent()
															.find(".sbi_lightbox_tooltip")
															.toggle();
													}),
												setTimeout(function () {
													if (
														(jQuery(
															"#sbi_images .sbi_item.sbi_new"
														).removeClass("sbi_new"),
									...
									createPage: function (e, i) {
										void 0 !== sb_instagram_js_options.ajax_url &&
											...
											(void 0 !== window.sbiajaxurl &&
												...
												(window.sbiajaxurl =
													"https://instagram.bretz-austria.at/wp-admin/admin-ajax.php"),
											t("#sbi-builder-app").length &&
												void 0 === window.sbiresizedImages &&
												t(".sbi_resized_image_data").length &&
												void 0 !==
													t(".sbi_resized_image_data").attr("data-resized") &&
												0 ===
												...
												t(".sbi_resized_image_data").remove()),
										...
										e.whenFeedsCreated(
											t(".sbi").each(function (e) {
												...
												var r = {
													...
													colstablet:
														void 0 !== i.attr("data-colstablet") &&
														"same" !== i.attr("data-colstablet")
															? i.attr("data-colstablet")
															: i.attr("data-cols"),
													colsmobile:
												...
												(window.sbi.feeds[e] = (function (t, e, i) {
													...
													jQuery(".sbi_palette_dark").length
														? jQuery("#sbi_lightbox").addClass(
																"sbi_palette_dark_lightbox"
														  )
														: jQuery(".sbi_palette_light").length &&
														  jQuery("#sbi_lightbox").addClass(
										...
										t(".sb_instagram_header").each(function () {
											...
											e.find(".sbi_header_link").on(
												...
												function (t) {
													switch (t.type) {
														case "mouseenter":
															e.find(".sbi_header_img_hover").addClass(
																"sbi_fade_in"
															);
															break;
														case "mouseleave":
															e.find(".sbi_header_img_hover").removeClass(
																"sbi_fade_in"
															);
													}
												}
									...
									(s.prototype = {
													...
													s &&
														...
														t(this).on("load", function () {
															!t(this).hasClass("sbi-replaced") &&
																t(this).attr("src").indexOf("placeholder") >
																	-1 &&
																(t(this).addClass("sbi-replaced"),
																s &&
																	(t(this).attr("src", s),
																	t(this).closest(".sbi_imgLiquid_bgSize")
																		.length &&
																		t(this)
										...
										sendNeedsResizingToServer: function () {
											...
											if (
												...
												i.needsResizing.length > 0 &&
													i.settings.resizingEnabled)
											) {
												...
												a(
													...
													function (e) {
														var s = e;
														for (var n in ("object" != typeof e &&
															0 === e.trim().indexOf("{") &&
															(s = JSON.parse(e.trim())),
														i.settings.debugEnabled && console.log(s),
														s))
															s.hasOwnProperty(n) &&
																(i.resizedImages[n] = s[n]);
														i.maybeRaiseImageResolution(),
															setTimeout(function () {
																i.afterResize();
															}, 500),
										...
										loadMoreButtonInit: function () {
											...
											e.find("#sbi_load .sbi_load_btn")
												.off()
												.on("click", function () {
													i.afterLoadMoreClicked(jQuery(this)),
														i.getNewPostSet();
												});
										},
											...
											if (
												...
												if (o.length < 1)
													...
													((e.find(".sbi_link_area").length &&
														...
														e
															.find(".sbi_link_area")
															.attr("href", o[o.length - 1]),
														void 0 !== o[640] &&
															e
																.find(".sbi_photo")
																.attr("data-full-res", o[640]),
													...
													if (
														...
														var g = o[d].split("?ig_cache_key")[0];
														if (
															(a !== g &&
																(e.find(".sbi_photo img").attr("src", g),
																e
																	.find(".sbi_photo")
															...
															e.find(".sbi_photo img").on("load", function () {
																var i = t(this),
																	s =
																		i.get(0).naturalWidth /
																		i.get(0).naturalHeight;
																if (
																	1e3 !== i.get(0).naturalWidth &&
																	s > l &&
																	!f
																) {
																	switch (
																		(n.settings.debugEnabled &&
																				...
																				"rais res again for aspect ratio change " +
																					a
																			),
																		(f = !0),
													...
													e.find("img").on("error", function () {
														if (t(this).hasClass("sbi_img_error"))
																...
																"unfixed error " + t(this).attr("src")
															);
														else {
															var e;
															if (
																(t(this).addClass("sbi_img_error"),
																t(this).attr("src").indexOf("media/?size=") >
																	-1 ||
																	t(this).attr("src").indexOf("cdninstagram") >
																		-1 ||
												...
												var e = t(this.el),
													...
													s =
														...
														"" !== e.attr("data-nummobile")
															...
															: i;
												t(window).width() < 480 ||
												"mobile" === window.sbi_preview_device
										...
										addToNeedsResizing: function (t) {
											-1 === this.needsResizing.indexOf(t) &&
												this.needsResizing.push(t);
										},
										applyImageLiquid: function () {
											var i = t(this.el);
											e(),
												"function" ==
													typeof i.find(".sbi_photo").sbi_imgLiquid &&
										...
										listenForVisibilityChange: function () {
											...
											(e = jQuery),
												...
												"function" ==
													typeof t(this.el).filter(":hidden")
												...
												e.hasClass("sbi_mob_col_auto")
													? (sbiWindowWidth < 640 &&
													  ...
													  sbiWindowWidth < 640 &&
															...
															parseInt(i) < 11 &&
															(o = 4),
													  sbiWindowWidth <= 480 && parseInt(i) > 2 && (o = 1))
													: sbiWindowWidth <= 480
													? (o = s)
													: sbiWindowWidth <= 640 && (o = n),
												parseInt(o)
											);
										},
										checkConsent: function () {
											...
											if (void 0 !== window.cookieyes)
												void 0 !== window.cookieyes._ckyConsentStore.get &&
													(this.settings.consentGiven =
														"yes" ===
														window.cookieyes._ckyConsentStore.get(
															"functional"
														));
												...
												void 0 !== window.cookieconsent
													...
													: void 0 !== window.BorlabsCookie &&
													  (this.settings.consentGiven =
															window.BorlabsCookie.checkCookieConsent(
																"instagram"
															));
										...
										locationGuess: function () {
											...
											return (
												e.closest("footer").length
													? (i = "footer")
													: e.closest(".header").length ||
													  e.closest("header").length
													? (i = "header")
													: (e.closest(".sidebar").length ||
															e.closest("aside").length) &&
													  (i = "sidebar"),
												i
											);
										},
								...
								var o = {
									...
									afterTypeChange: function (t) {
										jQuery(".sbi_mod_mode_type_select_wrap_box").removeClass(
											"sbi_mod_mode_selected"
										),
											"show" === t
												? (jQuery("#sbi_mod_permanent_toggle")
												  ...
												  jQuery("#sbi_hs_show")
														.closest(".sbi_mod_mode_type_select_wrap_box")
														.addClass("sbi_mod_mode_selected"))
												: (jQuery("#sbi_mod_permanent_toggle")
														.closest(".sbi_mod_row")
														.slideUp(),
												  jQuery("#sb_mod_is_permanent_warning").slideUp(),
												  jQuery("#sbi_hide_show")
														.closest(".sbi_mod_mode_type_select_wrap_box")
														.addClass("sbi_mod_mode_selected"));
									},
									mergeDBAndSelected: function () {
										if (!this.$self.hasClass("sbi_mod_merged")) {
											...
											for (t = 0; t < o.dbHidePhotos.length; t++)
												-1 ==
													o.selectedHide.indexOf(
														o.dbHidePhotos[t].replace("sbi_", "")
													) &&
													o.selectedHide.push(
														o.dbHidePhotos[t].replace("sbi_", "")
													);
											...
											for (t = 0; t < o.dbWhiteList.length; t++)
												-1 ==
													o.selectedShow.indexOf(
														o.dbWhiteList[t].replace("sbi_", "")
													) &&
													o.selectedShow.push(
														o.dbWhiteList[t].replace("sbi_", "")
													);
									...
									updateBlockUser: function (t) {
										var e = t.val();
										t.is(":checked")
											? o.selectedUsers.indexOf(e) < 0 &&
											  o.selectedUsers.push(e)
									...
									closeMod: function () {
										...
										t.indexOf("sbi_moderation_mode=true") > -1 &&
											(t = (t = t.replace(
												...
												""
											)).replace("&sbi_moderation_mode=true", "")),
									...
									ajaxSubmit: function () {
										...
										if (
											(void 0 !== t.attr("data-locatornonce") &&
												(e = t.attr("data-locatornonce")),
											void 0 !== t.attr("data-postid") &&
												(i = t.attr("data-postid")),
											...
											s = {
												...
												blocked_users: o.selectedUsers,
												permanent: jQuery("#sbi_mod_permanent_toggle").is(
													":checked"
												),
							...
							jQuery(document).ready(function (t) {
								void 0 === window.sb_instagram_js_options &&
									...
									t(".cli-user-preference-checkbox, .cky-notice button").on(
										"click",
										function () {
											setTimeout(function () {
												t.each(window.sbi.feeds, function (t) {
													window.sbi.feeds[t].checkConsent(),
														window.sbi.feeds[t].afterConsentToggled();
												});
											}, 1e3);
										}
									...
									t(".cmplz-btn").on("click", function () {
										"function" == typeof cmplz_accepted_categories &&
											setTimeout(function () {
												cmplz_accepted_categories().indexOf("marketing") > -1 &&
													t.each(window.sbi.feeds, function (t) {
														(window.sbi.feeds[t].settings.consentGiven = !0),
															window.sbi.feeds[t].afterConsentToggled();
													});
									...
									t("#sbi-frce-hide-license-error").on("click", function () {
										t("#sbi-fr-ce-license-error").slideUp(),
											jQuery.ajax({
				...
				840: (t, e, i) => {
					 ...
					 *
					 * Copyright (c) 2016 Jorik Tangelder;
					 * Licensed under the MIT license */ !(function (n, o, a, r) {
						"use strict";
						var h,
						...
						var F = "ontouchstart" in n,
							P = S(n, "PointerEvent") !== r,
							B =
								F &&
								/mobile|tablet|ip(ad|hone|od)|android/i.test(
									navigator.userAgent
						...
						function N(t, e, i) {
							...
							(i.isFirst = !!o),
								...
								(function (t, e) {
									...
									var d = U(e.deltaTime, e.deltaX, e.deltaY);
									(e.overallVelocityX = d.x),
										...
										(function (t, e) {
											...
											if (8 != e.eventType && (h > 25 || a.velocity === r)) {
						...
						H.prototype = {
							...
							destroy: function () {
								this.evEl && z(this.element, this.evEl, this.domHandler),
									this.evTarget &&
										z(this.target, this.evTarget, this.domHandler),
									this.evWin && z(L(this.element), this.evWin, this.domHandler);
							},
						};
							...
							y(ot, H, {
								handler: function (t) {
									var e = this.store,
										...
										s = t.type.toLowerCase().replace("ms", ""),
										n = et[s],
										o = it[t.pointerType] || t.pointerType,
										a = o == Q,
										r = j(e, t.pointerId, "pointerId");
									1 & n && (0 === t.button || a)
						...
						function dt(t, e) {
							var i = k(t.touches),
								s = k(t.changedTouches);
							return 12 & e && (i = D(i.concat(s), "identifier", !0)), [i, s];
						}
						y(lt, H, {
							handler: function (t) {
								var e = at[t.type];
						...
						function gt(t, e) {
							...
							for (n = 0; n < a.length; )
								s[a[n].identifier] && r.push(a[n]),
									12 & e && delete s[a[n].identifier],
									n++;
							return r.length ? [D(o.concat(r), "identifier", !0), r] : void 0;
						}
						y(pt, H, {
							handler: function (t) {
								var e = ut[t.type],
						...
						y(ft, H, {
							handler: function (t, e, i) {
								...
								if (
									...
									if (s) mt.call(this, e, i);
									else if (n && vt.call(this, i)) return;
									this.callback(t, e, i);
								}
							},
							destroy: function () {
							...
							set: function (t) {
								t == wt && (t = this.compute()),
									yt &&
										this.manager.element.style &&
										Et[t] &&
										(this.manager.element.style[bt] = t),
									(this.actions = t.toLowerCase().trim());
							},
							update: function () {
								this.set(this.manager.options.touchAction);
						...
						(kt.prototype = {
							...
							y(Ft, Lt, {
								...
								getTouchAction: function () {
									var t = this.options.direction,
										e = [];
									return 6 & t && e.push(Tt), t & $ && e.push(zt), e;
								},
								directionTest: function (t) {
									var e = this.options,
										i = !0,
							...
							y(Bt, kt, {
								...
								process: function (t) {
									var e = this.options,
										...
										s = t.distance < e.threshold,
										n = t.deltaTime > e.time;
									if (((this._input = t), !s || !i || (12 & t.eventType && !n)))
										this.reset();
								...
								process: function (t) {
									...
									if (s && n && i) {
										...
										var o =
											...
											a =
												!this.pCenter ||
												X(this.pCenter, t.center) < e.posThreshold;
										if (
											((this.pTime = t.timeStamp),
											(this.pCenter = t.center),
											a && o ? (this.count += 1) : (this.count = 1),
						...
						function Ht(t, e) {
							var i,
								s = t.element;
							s.style &&
								(m(t.options.cssProps, function (n, o) {
									(i = S(s.style, o)),
										e
											? ((t.oldCssProps[i] = s.style[i]), (s.style[i] = n))
											: (s.style[i] = t.oldCssProps[i] || "");
